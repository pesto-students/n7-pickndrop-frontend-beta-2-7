                    ...
                    <Grid item xs={12} md={9}>
                      <div className={classes.box}>
                        <div style={{ paddingTop: "5px" }}>
                          <span className={classes.orderDetails}>
                            Order Details
                          </span>
                        </div>
                        ...
                        <div style={{ textAlign: "left" }}>
                          {isPickedUp ? (
                              ...
                              {isDelieverd ? (
                                <>
                                  <Alert severity="success">
                                    Congrats! You've delivered the order and
                                    completed your task.
                                  </Alert>
                                </>
                              ) : (
                                <>
                                  <div>
                                    <Alert severity="info">
                                      Please go ahead and click below once you
                                      deliver the order.
                                    </Alert>
                                  </div>
                            ...
                            <>
                              <div>
                                <Alert severity="info">
                                  Please go ahead and click below once you pick
                                  up the order.
                                </Alert>
                              </div>
                              <div style={{ marginTop: "20px" }}>
